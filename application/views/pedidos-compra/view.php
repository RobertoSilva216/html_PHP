...
<?php if(isset($pedido['pedido_id'])){?>
    ...
    <div class="row">
        <div class="col-12 col-md-4 text-start no-print">
            <a href="<?=base_url()?>pedidos-compra" class="btn btn-outline-secondary">
        ...
        <div class="col-12 col-md-4 text-end no-print">
            <button onclick="print()" class="btn btn-outline-primary">
                <i class="fas fa-print"></i>
                IMPRIMIR
            </button>

<?php if($pedido['pedido_status']!=='entregue'){ ?>
            <button class="btn btn-outline-success ico-entregar-pedido" pedido_id="<?=$pedido['pedido_id']?>">

...
$(".btn-enviar").click(function(){
    ...
    if(status=='finalizado'){
        var msg_status='<strong> e finalizar</strong> o';
    }else{
        var msg_status=' do';
    }
    modal_confirmacao("Realmente enviar os novos dados"+msg_status+" pedido?",'enviarPedido("'+status+'");');
});


function enviarPedido(status='pendente'){
    modal_aviso("Salvando pedido...","spiner.gif",false);
    var dados={
    ...
    $.post(base_url+"meus-pedidos/novo-do", dados,  function(retorno) {
